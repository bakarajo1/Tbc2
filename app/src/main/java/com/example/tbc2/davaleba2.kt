package com.example.tbc2

class davaleba2 {

    object davaleba2 {

        var ertebi = arrayOf(" ", " erti", " ori", " sami", " otxi", " xuti", " eqvsi", " shvidi", " rva", " cxra", " ati", " tertmeti", " tormeti", " cameti", " totxmeti", " txutmeti", " teqvsmeti", " chvidmeti", " tvrameti", "cxrameti"
        )
        var sruliAtebi = arrayOf(" ", "ati ", " oci", " ocdaati", " ormoci", " ormocdaati", " samoci", " samocdaati", " otxmoci", " otxmocdaati")
        var atebi = arrayOf(" ", " ", " ocda", " ocda", " ormocda", " ormocda", " samocda", " samocda", " otxmocda", " otxmocda")
        var asebi = arrayOf(" ", "as ", " oras", " samas", " otxas", " xutas", " eqvsas", " shvidas", " rvaas", " cxraas")
        var sruliAsebi = arrayOf(" ", "asi ", " orasi", " samasi", " otxasi", " xutasi", " eqvsasi", " shvidasi", " rvaasi", " cxraasi")
        var baseString = ""
